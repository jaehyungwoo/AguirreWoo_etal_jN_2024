function plot_metrics_across_trials_group_mean(all_output, taskType, group_label, show_plots, shadedErrorbar, lesion_colors)
    
phaseTypes = {["D"],["R1","prob1000"],["R2","prob1000"],["R1","prob9010"],["R2","prob9010"],["R1","prob8020"],["R2","prob8020"],["R1","prob7030"],["R2","prob7030"]};
...
if plot_Behavioral_met    
    ...
    if length(phaseType)==2
        ...
        sgtitle(taskType+" task: "+phaseType(1)+"_{"+schd_lbl+"}");
    end
...
%             end
    ...
    if i==1
        ...
        L = legend({['R1-CNO (n=',num2str(NN(1)),')'],['R2-CNO (n=',num2str(NN(2)),')']});
        L.Box = 'off';
    end
